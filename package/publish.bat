...
:: ============================================================
::  StudyDash — Build & Publish helper
::  Uso:
...
if "%ACTION%"=="" (
    ...
    echo    local    Build + npm pack + instala globalmente para teste
...
if "%ACTION%"=="publish" (
    ...
    echo Publicado: studydash@!PKG_VERSION!
    echo https://www.npmjs.com/package/studydash
    exit /b 0
)
