    ...
    >
      <div className="flex flex-col gap-6">
        <div className="flex flex-col gap-4">
          <h2 className="font-semibold text-[var(--text-primary)] text-lg">Quando usar cada abordagem?</h2>
          <ul className="list-disc list-inside space-y-1 text-[var(--text-tertiary)] leading-relaxed">
            <li><strong className="text-[var(--text-secondary)]">Parallel.For / ForEach:</strong> cálculos intensivos de CPU — processa dados em paralelo no ThreadPool.</li>
            <li><strong className="text-[var(--text-secondary)]">Task.WhenAll:</strong> múltiplas operações I/O (HTTP, banco, arquivos) — não bloqueia threads enquanto espera.</li>
            <li><strong className="text-yellow-400">Atenção:</strong> use <code className="text-[var(--text-tertiary)] bg-[var(--bg-surface-hover)] px-1 rounded text-xs">ConcurrentBag&lt;T&gt;</code> ou <code className="text-[var(--text-tertiary)] bg-[var(--bg-surface-hover)] px-1 rounded text-xs">lock</code> para evitar condições de corrida.</li>
          </ul>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <ul className="list-disc list-inside space-y-1 text-[var(--text-tertiary)] leading-relaxed">
            ...
            <li><strong className="text-yellow-400">Deadlock:</strong> locks aninhados mal ordenados — prefira estruturas thread-safe (<code className="text-[var(--text-tertiary)] bg-[var(--bg-surface-hover)] px-1 rounded text-xs">ConcurrentBag</code>, <code className="text-[var(--text-tertiary)] bg-[var(--bg-surface-hover)] px-1 rounded text-xs">Interlocked</code>).</li>
