      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
          <div className="flex flex-col gap-3 bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-md p-4">
            <h2 className="font-semibold text-[var(--text-primary)]">Processamento Sequencial</h2>
            <ul className="space-y-1.5 text-[var(--text-tertiary)] leading-relaxed">
              <li>Um único worker processa os jobs um a um.</li>
              <li>Jobs somam <strong className="text-[var(--text-secondary)]">~1950ms</strong> em série.</li>
          ...
          <div className="flex flex-col gap-3 bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-md p-4">
            <h2 className="font-semibold text-[var(--text-primary)]">3 Workers em Paralelo</h2>
            <ul className="space-y-1.5 text-[var(--text-tertiary)] leading-relaxed">
              ...
              <li><strong className="text-[var(--text-secondary)]">prefetchCount=1</strong> garante distribuição justa.</li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3 bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-md p-4 text-sm">
          <h2 className="font-semibold text-[var(--text-primary)]">Quando usar Competing Consumers?</h2>
