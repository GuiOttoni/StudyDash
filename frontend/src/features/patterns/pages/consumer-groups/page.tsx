      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
          <div className="flex flex-col gap-3 bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-md p-4">
            <h2 className="font-semibold text-[var(--text-primary)]">RabbitMQ — Fila</h2>
            <ul className="space-y-1.5 text-[var(--text-tertiary)] leading-relaxed">
              ...
              <li>Dois consumers na mesma fila <strong className="text-[var(--text-secondary)]">competem</strong> (Competing Consumers).</li>
          ...
          <div className="flex flex-col gap-3 bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-md p-4">
            <h2 className="font-semibold text-[var(--text-primary)]">Kafka — Log Imutável</h2>
            <ul className="space-y-1.5 text-[var(--text-tertiary)] leading-relaxed">
              <li><strong className="text-emerald-400">Mensagem persiste</strong> no log — múltiplos grupos leem independentemente.</li>
              <li>Cada GroupId mantém seu próprio <strong className="text-[var(--text-secondary)]">offset</strong>.</li>
              <li>Replay: <code className="text-[var(--text-secondary)] bg-[var(--bg-surface-hover)] px-1 rounded text-xs">AutoOffsetReset.Earliest</code> → relê desde o início.</li>
        ...
        <div className="flex flex-col gap-3 bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-md p-4 text-sm">
          <h2 className="font-semibold text-[var(--text-primary)]">Fluxo da Demo</h2>
          <ol className="space-y-1.5 text-[var(--text-tertiary)] leading-relaxed list-decimal list-inside">
            <li>Producer publica 9 eventos com 3 chaves de domínio (orders, payments, inventory).</li>
            <li><code className="text-[var(--text-secondary)] bg-[var(--bg-surface-hover)] px-1 rounded text-xs">analytics-service</code> lê todos os 9 eventos do offset 0.</li>
            <li><code className="text-[var(--text-secondary)] bg-[var(--bg-surface-hover)] px-1 rounded text-xs">audit-service</code> faz <strong className="text-emerald-400">replay</strong> dos mesmos 9 eventos a partir do offset 0.</li>
