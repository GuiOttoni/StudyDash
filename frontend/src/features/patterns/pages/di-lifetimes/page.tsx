    ...
    >
      <div className="flex flex-col gap-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-[var(--bg-surface)] p-5 rounded-md border border-[var(--border-default)] flex flex-col gap-3">
            <div className="flex items-center gap-2">
              <span className="w-3 h-3 rounded-full bg-blue-400" />
              <h3 className="font-bold text-[var(--text-primary)] text-lg">Transient</h3>
            </div>
            ...
            <ul className="text-xs text-[var(--text-muted)] space-y-1 mt-auto">
          ...
          <div className="bg-[var(--bg-surface)] p-5 rounded-md border border-[var(--border-default)] flex flex-col gap-3">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-[var(--text-primary)] text-lg">Scoped</h3>
            </div>
            <p className="text-[var(--text-tertiary)] text-sm leading-relaxed">
          ...
          <div className="bg-[var(--bg-surface)] p-5 rounded-md border border-[var(--border-default)] flex flex-col gap-3">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-[var(--text-primary)] text-lg">Singleton</h3>
            </div>
            <p className="text-[var(--text-tertiary)] text-sm leading-relaxed">
        ...
        {/* Visual Analogy */}
        <div className="bg-[var(--bg-app)] border border-[var(--border-default)] rounded-lg p-6">
          <h3 className="text-[var(--text-primary)] font-semibold mb-4 flex items-center gap-2">
             💡 Analogia do Restaurante
          </h3>
          <div className="space-y-4 text-sm text-[var(--text-tertiary)]">
