      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
          {[
            ...
            <div key={cause} className="flex flex-col gap-2 bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-md p-4">
              ...
              <p className="text-[var(--text-tertiary)] leading-relaxed">{desc}</p>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
          <div className="flex flex-col gap-3 bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-md p-4">
            <h2 className="font-semibold text-[var(--text-primary)]">Fluxo da Mensagem</h2>
            <ol className="space-y-2 text-[var(--text-tertiary)] leading-relaxed list-decimal list-inside">
              <li>Producer publica para <code className="text-[var(--text-secondary)] bg-[var(--bg-surface-hover)] px-1 rounded text-xs">orders.exchange</code>.</li>
              <li>Mensagem entra em <code className="text-[var(--text-secondary)] bg-[var(--bg-surface-hover)] px-1 rounded text-xs">orders.main</code>.</li>
              ...
              <li>NACK (requeue:false) → RabbitMQ aplica <code className="text-[var(--text-secondary)] bg-[var(--bg-surface-hover)] px-1 rounded text-xs">x-dead-letter-exchange</code>.</li>
              <li>Mensagem chega em <code className="text-[var(--text-secondary)] bg-[var(--bg-surface-hover)] px-1 rounded text-xs">orders.dead</code> com headers <code className="text-[var(--text-secondary)] bg-[var(--bg-surface-hover)] px-1 rounded text-xs">x-death</code>.</li>
            </ol>
          </div>

          <div className="flex flex-col gap-3 bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-md p-4">
            <h2 className="font-semibold text-[var(--text-primary)]">Headers x-death</h2>
            <p className="text-[var(--text-tertiary)] text-sm leading-relaxed">
              Cada mensagem na DLQ carrega o header <code className="text-[var(--text-secondary)] bg-[var(--bg-surface-hover)] px-1 rounded text-xs">x-death</code> com:
            </p>
            <ul className="space-y-1.5 text-[var(--text-tertiary)] leading-relaxed">
              <li><code className="text-[var(--text-secondary)] bg-[var(--bg-surface-hover)] px-1 rounded text-xs">reason</code> — <span className="text-amber-400">rejected</span>, <span className="text-amber-400">expired</span> ou <span className="text-amber-400">maxlen</span></li>
              <li><code className="text-[var(--text-secondary)] bg-[var(--bg-surface-hover)] px-1 rounded text-xs">queue</code> — fila de origem</li>
              <li><code className="text-[var(--text-secondary)] bg-[var(--bg-surface-hover)] px-1 rounded text-xs">time</code> — timestamp da morte</li>
              <li><code className="text-[var(--text-secondary)] bg-[var(--bg-surface-hover)] px-1 rounded text-xs">count</code> — quantas vezes a mensagem morreu</li>
            </ul>
          </div>
        </div>

        <div className="flex flex-col gap-3 bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-md p-4 text-sm">
          <h2 className="font-semibold text-[var(--text-primary)]">Boas Práticas</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-[var(--text-tertiary)]">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-[var(--text-muted)] text-sm">
            ...
            com BasicNack e drena a DLQ exibindo os headers <code className="text-[var(--text-tertiary)] bg-[var(--bg-surface-hover)] px-1 rounded text-xs">x-death</code>.
          </p>
          <LogRunSection
