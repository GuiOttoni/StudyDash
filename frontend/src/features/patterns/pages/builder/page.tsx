import { BuilderRunSection } from "@/features/patterns/components/BuilderRunSection";
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-4">
          <h2 className="font-semibold text-[var(--text-primary)] text-lg">Participantes</h2>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-[var(--text-muted)] text-sm">
            ...
            <span className="text-[var(--text-tertiary)] font-mono text-xs bg-[var(--bg-surface-hover)] px-1.5 py-0.5 rounded">SSE</span>.
          </p>
