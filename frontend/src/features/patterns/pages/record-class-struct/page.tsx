    ...
    >
      <div className="flex flex-col gap-6">
        <div className="flex flex-col gap-4">
          <h2 className="font-semibold text-[var(--text-primary)] text-lg">Comparativo</h2>
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-[var(--text-tertiary)] border-collapse">
              <thead>
                <tr className="border-b border-[var(--border-strong)]">
                  <th className="text-left py-2 pr-4 text-[var(--text-secondary)] font-medium">Característica</th>
              ...
              <tbody className="space-y-1">
                {[
                  ...
                  <tr key={feat} className="border-b border-[var(--border-default)]">
                    <td className="py-2 pr-4 text-[var(--text-secondary)]">{feat}</td>
        ...
        <div className="flex flex-col gap-4">
          <h2 className="font-semibold text-[var(--text-primary)] text-lg">Quando usar cada um?</h2>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-[var(--text-muted)] text-sm">
            ...
            medida com <code className="text-[var(--text-tertiary)] bg-[var(--bg-surface-hover)] px-1 rounded text-xs">GC.GetTotalMemory()</code>.
          </p>
          <LogRunSection
